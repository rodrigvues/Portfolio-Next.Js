...
export default function Projeto({ title, description, tags, imageUrl }: ProjetoProps) {
    ...
    return  (
        ...
        >
            <section 
            className='group bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem]  even:pl-8 hover:bg-gray-200 transition'>
