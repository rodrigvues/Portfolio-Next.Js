...
function Projeto({ title, description, tags, imageUrl }: ProjetoProps) {
    return  <section className='group bg-gray-100 mas-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] mb-3 sm:mb-8 last:mb-0 even:pl-8 hover:bg-gray-200 transition'>
